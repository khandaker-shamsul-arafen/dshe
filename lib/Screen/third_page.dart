          ...
          children: [
                            ...
                            children: [
                              Container(
                                ...
                                child: Padding(
                                  ...
                                  child: Column(
                                    children: [
                                      customtxt(txt: "930", fontweight: FontWeight.w800, size: 20),
                                      SizedBox(height: 9,),
                                      customtxt(txt: "student", fontweight:FontWeight.w400, size: 13),
                                    ],
                                  ),
                                ),
                              ),
                              ...
                              Container(
                                ...
                                child: Padding(
                                  ...
                                  child: Column(
                                    children: [
                                      customtxt(txt: "30", fontweight: FontWeight.w800, size: 20),
                                     SizedBox(height: 9,),
                                      customtxt(txt: "Teachers", fontweight:FontWeight.w400, size: 13),
                                    ],
                                  ),
                                ),
                              )
            ...
            Padding(
              ...
              child: Align(alignment:Alignment.topLeft,
                  child: customtxt(txt: "Previous Decision", fontweight: FontWeight.w400, size: 18.0)),
            ),
            Padding(
